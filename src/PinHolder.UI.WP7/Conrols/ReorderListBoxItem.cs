...
namespace PinHolder.Conrols
{
    ...
    /// </summary>
    [TemplatePart(Name = DragHandlePart, Type = typeof(ContentPresenter))]
    [TemplatePart(Name = DropBeforeSpacePart, Type = typeof(UIElement))]
    [TemplatePart(Name = DropAfterSpacePart, Type = typeof(UIElement))]
    [TemplateVisualState(Name = ReorderDisabledState, GroupName = ReorderEnabledStateGroup)]
    [TemplateVisualState(Name = ReorderEnabledState, GroupName = ReorderEnabledStateGroup)]
    [TemplateVisualState(Name = NotDraggingState, GroupName = DraggingStateGroup)]
    [TemplateVisualState(Name = DraggingState, GroupName = DraggingStateGroup)]
    [TemplateVisualState(Name = NoDropIndicatorState, GroupName = DropIndicatorStateGroup)]
    [TemplateVisualState(Name = DropBeforeIndicatorState, GroupName = DropIndicatorStateGroup)]
    [TemplateVisualState(Name = DropAfterIndicatorState, GroupName = DropIndicatorStateGroup)]
    public class ReorderListBoxItem : ListBoxItem
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.DragHandle = this.GetTemplateChild(DragHandlePart) as ContentPresenter;
            ...
            VisualStateManager.GoToState(this, ReorderDisabledState, false);
            VisualStateManager.GoToState(this, NotDraggingState, false);
            VisualStateManager.GoToState(this, NoDropIndicatorState, false);
        }
    }
}
