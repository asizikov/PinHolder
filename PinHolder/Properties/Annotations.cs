...
namespace PinHolder.Annotations
{
  /// <summary>
  ...
  /// <summary>
  /// Indicates that this class/method is safe for multithreaded usage. If class marked with <see cref="ImmutableObjectAttribute"/> thread-safety is implicit. 
  /// If certain methods of class are thread-unsafe (e.g. iterators in synchronized dictionaries), you can annotate this methods with <see cref="ThreadUnsafeAttribute"/>
  /// </summary>
  ...
  public sealed class ReturnsThreadSafeAttribute : Attribute { }
}